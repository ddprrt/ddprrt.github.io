...
It was invented in 1996 by the same guy who invented HSL to address some of its problems, trying to make it even more intuitive for humans to understand and use. And after some experiments I've to say: Oh yeah, that's something!
...
If you are familiar with HSL, you know what to expect from the very first parameter, the H (Hue). If you imagine the colours of a rainbow, the start at red, go over orange, yellow, green, blue and indigo to violet. The hue tells us how far we are on that spectrum. From violet it goes back to red, giving us a colour cycle that spans all 360 degrees. 

![The colour cycle by Newton in 1700s](/wp-content/uploads/2014/newton.jpg)

With the hue we specify the angle on that cycle, starting with red at 0 degrees. If you want an easy way to remember the order of the primary colours, just remember the old guy [Roy G. Biv](http://en.wikipedia.org/wiki/Roy_G._Biv). Each letter stands for one of the main colours in that cycle.
...
I'm really looking forward to it, in the meantime I guess I'll create a plugin for [Rework](https://github.com/reworkcss/rework) or something for that Sass thing over there!
