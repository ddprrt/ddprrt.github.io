...
1. A light-weight component layer. Since Preact is based on React, and in React everything is a component, this is the root of whatever you want to create. The component layer has around 3KB and allows you to compose and reuse pieces of markup, as well as introducing state through class components.
